...
# Installation
The system has been deployed on render.com (https://deepmint.onrender.com/) and railway.app (https://deepmint.up.railway.app/) hosting platforms and can be accessed from there. Alternatively, the system can also be set up to run locally.
